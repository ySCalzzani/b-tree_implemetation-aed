...
if [ $? -ne 0 ]; then
    echo "Erro na compilação! Verifique o seu código/Makefile e tente novamente."
    exit 1
fi
...
echo "M,numKeys,tipo,reads,writes,tempo_s,tamanho_bytes" > $OUTPUT_FILE
echo "      Ficheiro de saída '$OUTPUT_FILE' criado com sucesso."

ORDENS=(3 100 1000)
CHAVES=(1000 10000 50000 100000)
TIPOS=(1 0) 
